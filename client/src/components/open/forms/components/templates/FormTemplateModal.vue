...
export default {
  ...
  methods: {
    ...
    async createFormTemplate () {
      ...
      await this.templateForm.post('/wp-json/hello2forms/v1/TemplateController', {
        headers: {
    ...
    async updateFormTemplate () {
      this.templateForm.form = this.form
      await this.templateForm.put('/wp-json/hello2forms/v1/TemplateController/' + this.template.id, {
        headers: {
          'X-WP-Nonce': window.hello2formsConfig.nonce
        }
      }).then((response) => {
    ...
    async deleteFormTemplate () {
      ...
      axios.delete('/wp-json/hello2forms/v1/TemplateController/' + this.template.id).then((response) => {
        if (response.data.message) {
          this.alertSuccess(response.data.message)
        }
