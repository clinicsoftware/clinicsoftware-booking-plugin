...
export default {
  ...
  mounted() {
    this.formFields = this.form.actions;
  },
  watch: {
    formFields: {
      deep: true,
      handler() {
        this.$set(this.form, 'actions', this.formFields)
      }
    },
    ...
    'form.actions': {
      ...
      handler() {
        ...
        if (this.form.actions.length !== this.formFields.length ||
          JSON.stringify(this.form.actions) !== JSON.stringify(this.formFields)) {
          this.formFields = clonedeep(this.form.actions)
        }
      }
    }
  ...
  methods: {
    ...
    editOptions(index) {
      this.$store.commit('open/action_form/openSettingsForField', index)
    },
    ...
    openAddFieldSidebar() {
      this.$store.commit('open/action_form/openAddFieldSidebar', null)
    }
  }
}
</script>
