  ...
  <div class="inline" v-if="shouldDisplayProTag">
    ...
    <modal :show="showPremiumModal" @close="showPremiumModal=false">
      ...
      <h4 v-if="user &&user.is_subscribed && !user.has_enterprise_subscription" class="text-center mt-5">
        We're happy to have you as a Pro customer. If you're having any issue with Hello2Forms, or if you have a
        feature request, please <a href="mailto:connect@clinicsoftware.com">contact us</a>.
        <br><br>
      ...
      <h4 v-if="user && user.is_subscribed && user.has_enterprise_subscription" class="text-center mt-5">
        We're happy to have you as an Enterprise customer. If you're having any issue with Hello2Forms, or if you have a
        feature request, please <a href="mailto:connect@clinicsoftware.com">contact us</a>.
      </h4>
      <p v-if="user && !user.is_subscribed" class="mt-4">
        ...
        >
          PRO
        </span> tag are available in the Pro plan of Hello2Forms. <b>You can play around and try all Pro features
          within
...
export default {
  ...
  computed: {
    ...
    shouldDisplayProTag() {
      if(!window.hello2formsConfig.paid_plans_enabled) return false
