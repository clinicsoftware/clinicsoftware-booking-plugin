...
export default {
  ...
  methods: {
    ...
    loadAmplitude () {
      if (this.loaded || !typeof window.amplitude === 'undefined' || !window.hello2formsConfig.amplitude_code) return
      ...
      this.amplitudeInstance.init(window.hello2formsConfig.amplitude_code)
      this.loaded = true
      this.authenticateUser()
    }
  }
