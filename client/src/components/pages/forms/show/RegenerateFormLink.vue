      ...
      <div class="p-4">
        ...
        <div class="border-t py-4 mt-4">
          ...
          <p class="text-gray-600 border p-4 bg-gray-50 rounded-md mt-4">
            https://clinicsoftware.com/forms/contact
          </p>
        ...
        <div class="border-t pt-4 mt-4">
          ...
          <p class="text-gray-600 p-4 border bg-gray-50 rounded-md mt-4">
            https://clinicsoftware.com/forms/b4417f9c-34ae-4421-8006-832ee47786e7
          </p>
          <div class="text-center mt-4">
...
export default {
  ...
  computed: {
    formEndpoint: () => '/wp-json/hello2forms/v1/FormController/{id}',
  },
